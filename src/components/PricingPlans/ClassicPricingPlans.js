...
const ClassicPricingPlans = ({ toggleSwitch, plans, animation }) => {
            ...
            (
              ...
              return (
                <Col
                  ...
                  key={index}
                >
                  <div className="pricing-wrapper my-3">
                    <div
                      className={`pricing-wrapper__table DetailedStyle kd-animated fadeInUp kd-animate ${
                        heighlightColor === '1' ? 'active' : ''
                      } ${discount === '1' ? 'has-bg-color' : ''}`}
                    ...
                    >
                      ...
                      <div className={`table__pricing`}>
                        <div className="plans">
                          ...
                          {description && (
                            <span className="pricing-subtitle text-center">
                              {description}
                            </span>
                          )}
                        </div>

                        <div className="pricing-options-container DetailedStyle">
                          {addItem.length > 0 &&
                            addItem.map((item, index) => {
                              return (
                                <div className="pricing-row" key={index}>
                                  <div className="pricing-value">
                                    <div className="pricing-option pricing-opt-no-icon">
                                      ...
                                      {item.tooltipText && (
                                        <span className="pricing-tooltip-content">
                        ...
                        {buttonLabel && (
                          <Link
                            ...
                            target="_self"
                          >
                            <span className="prim_text">{buttonLabel}</span>
                          </Link>
                        )}
                      </div>
                    </div>
...
export default ClassicPricingPlans
